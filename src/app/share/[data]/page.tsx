    ...
    return (
      <div className="min-h-[100dvh] bg-gradient-warm flex items-center justify-center px-6">
        <div className="glass-card p-8 text-center max-w-sm">
          <p className="text-lg text-[#312e29] mb-4">This share link is invalid.</p>
          <Link
            href="/"
            className="inline-block rounded-xl bg-gradient-to-r from-[#8d4837] to-[#6d2e20] px-6 py-3 text-white font-semibold text-sm hover:shadow-md transition-all"
          >
            Go to RelAI
          </Link>
        </div>
    ...
    <div className="min-h-[100dvh] bg-gradient-warm flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="glass-card p-8 sm:p-10 text-center mb-6">
          ...
          <p className="text-xs tracking-[0.2em] uppercase font-medium text-[#8d4837] mb-3">
            My relationship archetype
          </p>

          <h1 className="font-heading text-3xl sm:text-4xl font-semibold text-[#312e29] mb-4 tracking-tight">
            {archetype.name}
          </h1>

          <p className="text-lg text-[#7a766f] italic leading-relaxed">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-sm font-semibold text-[#312e29] tracking-tight">RelAI</span>
          </div>
          <p className="text-xs text-[#7a766f]">AI-powered relationship coaching</p>
        </div>
        ...
        <div className="text-center mt-6">
          <Link
            href="/"
            className="inline-block w-full rounded-xl bg-gradient-to-r from-[#8d4837] to-[#6d2e20] px-6 py-4 text-white font-semibold text-base hover:shadow-md transition-all btn-glow"
          >
            Discover your archetype
          </Link>
          <p className="text-[10px] text-[#b1ada5] mt-4 tracking-wide">
