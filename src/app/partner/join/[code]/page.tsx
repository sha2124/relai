...
export default function PartnerJoinPage() {
    ...
    return (
      <div className="min-h-[100dvh] bg-gradient-warm flex items-center justify-center">
        <div className="text-center stagger-in">
          ...
          <p className="text-[#7a766f] text-sm">
    ...
    return (
      <div className="min-h-[100dvh] bg-gradient-warm flex items-center justify-center px-6">
        <div className="max-w-lg mx-auto text-center stagger-in">
          <div className="h-20 w-20 rounded-full bg-[#81502b]/10 border-2 border-[#81502b]/20 flex items-center justify-center mx-auto mb-6">
          ...
          <h1 className="font-heading text-2xl font-semibold text-[#312e29] mb-3">
            Take the quiz first
          </h1>
          <p className="text-[#7a766f] mb-6">
            You need to complete the relationship quiz before linking with your partner.
          </p>
          <button
            type="button"
            onClick={() => router.push(`/quiz`)}
            className="rounded-xl bg-gradient-to-r from-[#8d4837] to-[#6d2e20] px-6 py-3 text-white font-semibold hover:shadow-md transition-all"
          >
            Take the quiz
          </button>
        </div>
  ...
  if (status === "error") {
    ...
    return (
      <div className="min-h-[100dvh] bg-gradient-warm flex items-center justify-center px-6">
        <div className="max-w-lg mx-auto text-center stagger-in">
          <div className="h-20 w-20 rounded-full bg-[#b41340]/10 border-2 border-[#b41340]/20 flex items-center justify-center mx-auto mb-6">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#b41340" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="space-y-3">
            {isOwnInvite && (
              <button
                ...
                className="w-full rounded-xl bg-gradient-to-r from-[#8d4837] to-[#6d2e20] px-6 py-3.5 text-white font-semibold text-sm hover:shadow-md transition-all"
              >
            ...
            <button
              ...
              className="w-full rounded-xl border border-[#e2dcd1] bg-white/50 px-6 py-3 text-sm text-[#8d4837] font-medium hover:bg-white transition-all"
            >
              Go to partner page
            </button>
          </div>
  ...
  return (
    <div className="min-h-[100dvh] bg-gradient-warm">
      <div className="px-6 pt-12 pb-8">
        <div className="max-w-lg mx-auto text-center stagger-in">
          <div className="h-20 w-20 rounded-full bg-[#8d4837]/10 border-2 border-[#8d4837]/20 flex items-center justify-center mx-auto mb-6">
          ...
          <h1 className="font-heading text-3xl font-semibold text-[#312e29] mb-3 tracking-tight">
            {status === "already-linked" ? "You're already linked!" : "You're linked!"}
          </h1>
          <p className="text-[#7a766f] text-base mb-8">
            {myName && partnerName
          ...
          {myArchetype && partnerArchetype && (
            <div className="space-y-6 mb-8">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/70 backdrop-blur-sm border border-[#e2dcd1] rounded-2xl p-5 shadow-sm text-center">
                  <div
                  ...
                  <p className="font-heading text-sm font-semibold text-[#312e29]">
                    {myArchetype.name}
                  </p>
                </div>
